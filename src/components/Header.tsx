...
const zipaLogo = "/zipa-logo-transparent.png";
...
export function Header() {
  ...
  const currentPage =
    routerLocation.pathname === "/" ? "home" : routerLocation.pathname.slice(1);
  ...
  const navItems = [
    ...
    },
    {
      ...
      gradient: navGradients.events,
    },
    {
      key: "theatre",
      path: "/theatre",
      label: t("theatre"),
      isActive: currentPage === "theatre",
      gradient: navGradients.theatre,
    },
    {
      key: "cinema",
      path: "/cinema",
      label: t("cinema"),
      isActive: currentPage === "cinema",
      gradient: navGradients.cinema,
    },
    {
      key: "concerts",
      path: "/concerts",
      label: t("concerts"),
      isActive: currentPage === "concerts",
      gradient: navGradients.concerts,
    },
    {
      key: "clubs",
      path: "/clubs",
      label: t("clubs"),
      isActive: currentPage === "clubs",
      gradient: navGradients.clubs,
    },
    {
      key: "foodAndDrink",
      path: "/food-and-drink",
      label: t("foodAndDrink"),
      isActive:
        currentPage === "food-and-drink" ||
        currentPage.startsWith("food-and-drink"),
      gradient: navGradients.foodAndDrink,
    },
  ];

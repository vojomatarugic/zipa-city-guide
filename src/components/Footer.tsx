...
import { BACKGROUNDS, BORDERS, TEXT, BRAND, GRADIENTS, getGradientTextStyle } from '../utils/colors';
  ...
  return (
    ...
    >
      ...
      >
        {/* Links Grid */}
        <div 
          className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 items-start"
        >
          {/* COLUMN 1: Explore */}

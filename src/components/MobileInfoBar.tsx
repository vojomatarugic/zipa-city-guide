  ...
  return (
    ...
    >
      <div className="w-full overflow-x-auto">
        <div className="px-4 py-2 flex items-center gap-3 min-w-max text-sm text-[#1a1a1a]">
          <button
            type="button"
          ...
          <button
            ...
            className="h-10 inline-flex items-center gap-1.5 whitespace-nowrap"
          >
          ...
          <button
            ...
            className="h-10 inline-flex items-center text-sm font-semibold text-[#0E3DC5] whitespace-nowrap"
          >
